...
class Rectangle(Parallelogram):
    ...
    def __str__(self):
        ...
        x="rectangle at " + Shape.__str__(self) + ', dimension ' +`self.getL1()` + 'x' + `self.getL2()` +', area '+`self.getArea()`
        return x
...
def draw_shapes(panel):
    ...
    # REPLACE ME!
    s8 = Rectangle(x+1*h, y-2*vert2- h/3, 60, 20)
    ...
    # REPLACE ME!
    s9 = Rectangle(x-3*h, y-2*vert2- h/3, 60, 20)
