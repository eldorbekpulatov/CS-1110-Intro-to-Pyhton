...
class Blackjack(object):
    ...
    def __init__(self, deck):
        ...
        Parameter deck: The deck of cards to play with
    ...
    def __str__(self):
        ...
        ds=self.dealerScore()
        ps=self.playerScore()
        return "player: " + str(ps)+"; dealer: "+ str(ds)
    
    def dealerScore(self):
        """Returns: score for the dealer."""
        clist=self.dealerHand
        ds=self._score(clist)
        return ds
    
    def playerScore(self):
        """Returns: score for the player."""
        clist=self.playerHand
        ps=self._score(clist)
        return ps
